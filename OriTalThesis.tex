...
\begin{figure*}
	...
	\begin{subfigure}[t]{1.0\textwidth}
		...
		\caption{A diagram of the CNN-LSTM model used in our experiments. Unlike the CNN model, there are connections between cells from the same layer. Only the last sequence is connected to the fully connected layer.}
